export class RequestApi {
  ...
  public get(url: string, options?: RequestInit): object {
    return this.createRequest('GET', url, options);
  }

  public post(url: string, body?: Record<string, any>, options?: RequestInit): object {
    const fullOptions = Object.assign({}, { body: JSON.stringify(body) }, options);
    return this.createRequest('POST', url, fullOptions);
  }

  public put(url: string, body?: Record<string, any>, options?: RequestInit): object {
    const fullOptions = Object.assign({}, { body: JSON.stringify(body) }, options);
    return this.createRequest('PUT', url, fullOptions);
  }

  public patch(url: string, body?: Record<string, any>, options?: RequestInit): object {
    const fullOptions = Object.assign({}, { body: JSON.stringify(body) }, options);
    return this.createRequest('PATCH', url, fullOptions);
  }

  public delete(url: string, body?: Record<string, any>, options?: RequestInit): object {
    const fullOptions = Object.assign({}, { body: JSON.stringify(body) }, options);
    return this.createRequest('DELETE', url, fullOptions);
  }

  private createRequest(method: string, url?: string, options?: RequestInit): object {
